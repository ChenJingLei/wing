...
@Data
public class WOAuth2ClientDetails implements ClientDetails {
    ...
    public WOAuth2ClientDetails() {
    }

    public WOAuth2ClientDetails(ClientDetails prototype) {
        this();
    ...
    public WOAuth2ClientDetails(String clientId, String resourceIds,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WOAuth2ClientDetails other = (WOAuth2ClientDetails) obj;
    ...
    public String toString() {
        return "WOAuth2ClientDetails [clientId=" + clientId + ", clientSecret="
